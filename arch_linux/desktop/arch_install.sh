...
# install packages
pacstrap -K /mnt base base-devel linux-lts linux linux-firmware sudo amd-ucode
...
pacman -Syu \$(curl https://raw.githubusercontent.com/konjiii/install_scripts/master/arch_linux/desktop/packages/pacman) --needed
...
curl https://raw.githubusercontent.com/konjiii/install_scripts/master/arch_linux/desktop/post_reboot.sh\
